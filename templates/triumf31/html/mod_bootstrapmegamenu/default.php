...
$min_css = $params->get('minified_css', 1) ? '.min' : '';
//$min_css = '';
...
if ($params->get('enable_hoverdropdown', 0))
{
...
?>
<div class="tvtma-megamnu navbar <?php echo $params->get('navbar_class', ''); ?>" role="navigation">
        <div class="container">
                <div class="navbar-header">
                        <?php if ($logo = $params->get('show_toggle_nav_btn', 1)): ?>
                        ...
                        <?php if ($logo = $params->get('logo', '')): ?>
                                ...
                                <?php endif; ?>
                                <?php if ($logo_img_style = $params->get('logo_img_style', '')): ?>
                                        <?php $logo_img_style = 'style="' . $logo_img_style . '" '; ?>
                                <?php endif; ?>
                                <?php if ($params->get('enable_logo_link', '')): ?>
                                        ...
                                        <?php endif; ?>
                                        <a <?php echo $logo_link_class; ?>href="<?php echo $default_mnu->flink; ?>" title="<?php echo $sitename; ?>">
                                        <?php endif; ?>
                                        <img <?php echo $logo_img_class . $logo_img_style; ?>src="<?php echo $logo; ?>" alt="<?php echo $sitename; ?>" />
                            ...
                            foreach ($list as $i => &$item) :
                                    ...
                                    if ($item->col_header)
                                    {
                                            ...
                                            if ($item->multicol_start)
                                            {
                                                    ...
                                                    echo '<ul class="' . $list_unstyled . ' dropdown-menu"' . $offset_style . '>
                                                                <li>
                                                                <div class="' . $row . '">
                                    ...
                                    elseif ($item->deeper)
                                    {
                                            echo '<ul class="' . $list_unstyled . ' dropdown-menu">';
