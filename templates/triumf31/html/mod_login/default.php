...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-inline">
    ...
    <div class="userdata">
            ...
            <div class="controls">
                <?php if (!$params->get('usetext')) : ?>
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input id="modlgn-username" type="text" name="username" class="form-control input-small" tabindex="0" size="18" value="" placeholder="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>">                                        
                    </div>
            ...
            <div class="controls">
                <?php if (!$params->get('usetext')) : ?>
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input id="modlgn-passwd" type="password" name="password" class="form-control input-small" tabindex="0" size="18" value="" placeholder="<?php echo JText::_('JGLOBAL_PASSWORD') ?>">                                        
                    </div>
        ...
        <div id="form-login-submit" class="control-group">
            <div class="controls">
                <button type="submit" tabindex="0" name="Submit" class="btn btn-sm btn-primary"><?php echo JText::_('JLOGIN') ?></button>
            </div>
        </div>
