                ...
                <div class="modal-dialog" style="width:700px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="contactLabel">Компания «Триумф»</h4>
                        </div>
    ...
    <div class="col-xs-12">
        ...
        <script type="text/javascript">
            ...
            function init2() {
                ...
                /*myMap.controls.add('typeSelector').add('mapTools', {left: 35, top: 5}).add('zoomControl', {
                    left: 5,
                    top: 5
                });*/

                cluster.add(new ymaps.Placemark([<?php echo $this->contact->country; ?>], {
                    iconContent: "<?php echo $this->contact->con_position; ?>",
                    balloonContent: "<?php echo nl2br($this->contact->address); ?>,<br/>тел: <?php echo nl2br($this->contact->telephone); ?>",
                    hintContent: "Открыть!"
